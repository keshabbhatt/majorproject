    ...
    <div className="min-h-screen ai-mesh-background py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-black/50 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-800">
        ...
        {/* Current Courses */}
        <div className="bg-black/50 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-gray-800 mb-8">
